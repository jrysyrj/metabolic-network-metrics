...
savedirL    = "/home/jrys/orcd/pool/metabolic-network-metrics/planets/results/sgdMMDS/LGRASSMANN_planets/"
savedirLint = "/home/jrys/orcd/pool/metabolic-network-metrics/planets/results/sgdMMDS/LGRASSMANN_planets_int/"
savedirR    = "/home/jrys/orcd/pool/metabolic-network-metrics/planets/results/sgdMMDS/RGRASSMANN_planets/"
loadDir     = "/home/jrys/orcd/pool/metabolic-network-metrics/planets/results/distances/"

files = readdir(loadDir)
L_GRASSMANN_FILES      = [loadDir*i for i in files if !isnothing(match(r"planets_LNS_\d+of\d+.csv",i))];
L_GRASSMANN_int_FILES = [loadDir*i for i in files if !isnothing(match(r"planets_int_LNS_\d+of\d+.csv",i))];
R_GRASSMANN_FILES      = [loadDir*i for i in files if !isnothing(match(r"planets_RNS_\d+of\d+.csv",i))];
