...
fileList = dir([basePath 'consistent_subAGORA2/*_consistent.mat']);
...
fileNames = [fileNames; [basePath 'Bacillus_subtilis_subsp_subtilis_str_NCIB_3610_consistent.mat'] ]
fileNames = [fileNames; [basePath 'Escherichia_coli_str_K_12_substr_MG1655_consistent.mat'] ]
