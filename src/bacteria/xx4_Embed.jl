...
savedirL    = "/home/jrys/orcd/pool/metabolic-network-metrics/bacteria/results/sgdMMDS/LGRASSMANN_subAGORA2/"
savedirLint = "/home/jrys/orcd/pool/metabolic-network-metrics/bacteria/results/sgdMMDS/LGRASSMANN_subAGORA2_int/"
savedirR    = "/home/jrys/orcd/pool/metabolic-network-metrics/bacteria/results/sgdMMDS/RGRASSMANN_subAGORA2/"
loadDir     = "/home/jrys/orcd/pool/metabolic-network-metrics/bacteria/results/distances/"

files = readdir(loadDir)
L_GRASSMANN_FILES      = [loadDir*i for i in files if !isnothing(match(r"subAGORA2_LNS_\d+of\d+.csv",i))];
L_GRASSMANN_int_FILES = [loadDir*i for i in files if !isnothing(match(r"subAGORA2_int_LNS_\d+of\d+.csv",i))];
R_GRASSMANN_FILES      = [loadDir*i for i in files if !isnothing(match(r"subAGORA2_RNS_\d+of\d+.csv",i))];
