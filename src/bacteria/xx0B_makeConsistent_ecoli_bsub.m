...
save([resultsPath filesep 'Model_statistics_ecoli_bsub'],'stats','-v7.3');
save([resultsPath filesep 'ATP_production_ecoli_bsub'],'atp','-v7.3');
save([resultsPath filesep 'Stoch_Flux_Consistency_ecoli_bsub'],'SFconsist','-v7.3');
...
cell2csv([resultsPath filesep 'Stoich_Flux_Consistency_ecoli_bsub.csv'],table)
